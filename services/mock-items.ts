export let ITEMS = [
  {
    ...
    short_description: "1:1 SUGAR REPLACEMENT Lakanto has a perfect mix of monk fruit and erythritol to match the sweetness of sugar and maintain your baking and cooking needs",
    description: "",
    option_groups: [
      {
        name: "Bundle",
